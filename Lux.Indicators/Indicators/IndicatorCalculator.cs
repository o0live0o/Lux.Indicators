...
public static class IndicatorCalculator
{
    ...
    public static List<double> CalculateEMA(List<double> values, int period)
    {
        ...
        double ema = values[0]; // 第一个EMA值等于第一个数据值
    ...
    public static List<double> CalculateStandardDeviation(List<double> values, int period)
    {
        var result = new List<double>();
        ...
        for (int i = 0; i < values.Count; i++)
        {
            ...
            else
            {
                ...
                var stdDev = (double)Math.Sqrt((double)variance);
    ...
    public static List<double> CalculateMax(List<double> values, int period)
    {
        var result = new List<double>();
    ...
    public static List<double> CalculateMin(List<double> values, int period)
    {
        var result = new List<double>();
